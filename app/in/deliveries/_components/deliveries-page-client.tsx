							...
							<Card>
								...
								<CardContent>
									<FilterButton
										...
										statusCounts={statusCounts.paid}
										onHandleStatusClick={() => handleStatusClick('paid')}
									/>
									<FilterButton
										filterStatus='unpaid'
										currentFilter={filterStatus}
										statusCounts={statusCounts.unpaid}
										onHandleStatusClick={() => handleStatusClick('unpaid')}
									/>
								</CardContent>
							</Card>
							...
							<Card>
								...
								<CardContent>
									<FilterButton
										...
										currentFilter={filterStatus}
										statusCounts={statusCounts.pending}
										onHandleStatusClick={() => handleStatusClick('pending')}
									/>
									<FilterButton
										filterStatus='successful'
										currentFilter={filterStatus}
										statusCounts={statusCounts.successful}
										onHandleStatusClick={() => handleStatusClick('successful')}
									/>
									<FilterButton
										filterStatus='failed'
										currentFilter={filterStatus}
										statusCounts={statusCounts.failed}
										onHandleStatusClick={() => handleStatusClick('failed')}
									/>
								</CardContent>
							</Card>
						</div>
